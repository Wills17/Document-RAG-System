...
> 💡 Tip: You’ll need your own **Gemini API Key** — the app will prompt you to enter it before use.
...
* `chunk_size` and `chunk_overlap` in `flask_app.py`
* The **system message** for tone or depth
* The **Gemini model** (`gemini-2.5-flash`, `gemini-1.5-pro`, etc.)
